...
public class MailUtil {
    public static void sendMail(String subject, String content) {
        ...
        try {
            ...
            InternetAddress fromAddr = new InternetAddress("zz5726615@163.com", "爬虫节点监控系统");// 发件人的信息，请填写自己的
            InternetAddress toAddr = new InternetAddress("315909056@qq.com", "zz");// 收件人的信息，请填写自己的
            ...
            t.connect("zz5726615@163.com", "aaa5724433");//这里登陆的时候最好使用126邮箱经过认证之后的密码，请填写自己的
