...
class Extractor():
    ...
    def getRawPage(self):
        ...
        try:
            resp = req.get(self.url,  headers=headers,timeout=self.timeout)
        ...
        return resp.status_code, resp.content.decode('gb2312','ignore')
...
if __name__ == '__main__':
    ext = Extractor(url="https://www.channelnewsasia.com/news/business/shares-knocked-lower-after-new-us-tariff-threat-on-chinese-goods-10727440",blockSize=5, image=False)
