...
Cookie = 'maxPageNum5097045=254; __jsluid=328605e1a60939bf562083db25a6a7a2; __jsl_clearance=1552896000.412|0|qUGr3E7XZyTrOXs156swzL%2Ff1%2F8%3D; zh_choose=n'
...
def standard_work_list():
    ...
    infos = html_page.findAll(id='comp_5097045')
...
def standard_work_article(target_url):
    ...
    html_page = bs4.BeautifulSoup(reg_content, 'lxml')
    infos = html_page.find(class_='arcConDiv').findAll('p')
    for one_info in infos:
