...
def standard_work_list():
    ...
    for one_info in infos:
        ...
        if content_dir:
            _datetime = 0
            _url_tmp = content_dir['href'].replace('./','http://www.jl.gov.cn/szf/ldhd/')
...
def standard_work_article(target_url):
    ...
    _title = re.findall(r'<meta name="ArticleTitle" content="(?P<title>.+?)"/>',reg_content)
