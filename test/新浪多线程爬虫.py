    ...
    def run(self):
        ...
        while not CRAWL_EXIT:
            try:
                ...
                url = 'https://feed.mix.sina.com.cn/api/roll/get?pageid=153&lid=2509&k=&num=50&page=%s&r=0.2039175258717716&callback=jQuery111202898175079273473_1548138061938&_=1548138061939' % (
                    page)
                ...
                for one_info in data:
                    ...
                    print(self.threadName +' '+_url_tmp+ '  ' + 'title:' + title)
...
def main():
    ...
    # 三个采集线程的名字
    crawlList = ["采集线程1号", "采集线程2号", "采集线程3号","采集线程4号"]
    # 存储三个采集线程的列表集合
    threadcrawl = []
