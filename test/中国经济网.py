...
def standard_work_list():
    ...
    res = requests.get('http://www.ce.cn/xwzx/gnsz/gdxw/', headers=headers)
    ...
    for one_info in infos:
        ...
        if content_dir:
            ...
            _url_tmp = _url_tmp.replace('../../../','http://www.ce.cn/cysc/')
            _url_tmp = _url_tmp.replace('./', 'http://www.ce.cn/xwzx/gnsz/gdxw/')
