...
def standard_work_list():
    ...
    res = requests.get('http://www.mofcom.gov.cn/article/ae/ai/', headers=headers)
    res.raise_for_status()
    reg_content = res.content.decode('utf8')
    html_page = bs4.BeautifulSoup(reg_content, 'lxml')
    infos = html_page.find(class_='u-newsList01 f-mt10').findAll('a')
    for one_info in infos:
        ...
        if content_dir:
            ...
            _url_tmp ='http://www.mofcom.gov.cn'+_url_tmp
