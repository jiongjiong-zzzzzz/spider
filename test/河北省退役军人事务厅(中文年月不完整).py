...
def standard_work_list():
    ...
    res = requests.get('http://tyjrswt.hebei.gov.cn/gk/ywgz/', headers=headers)
    res.raise_for_status()
    reg_content = res.content.decode('utf-8')
    infos = re.findall(r'a&#32;href=&quot;(?P<url>.+?)&quot;&#32;onclick=&quot;void(0)&quot;&#32;target=&quot;_blank&quot;&#32;title=&quot;(?P<title>.+?>)&quot;&gt;.+?&lt;/a',reg_content)
